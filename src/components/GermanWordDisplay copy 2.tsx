// 修改后的 GermanWordDisplay 组件，支持多语言
...
import { useApp } from "../contexts/AppContext"; // 导入多语言context
            ...
            <Card key={index} withBorder radius="sm" p="sm" bg="gray.0">
              <Group justify="space-between" align="flex-start" gap="xs">
                <div style={{ flex: 1 }}>
                  ...
                  <Stack gap={4}>
                    <Text size="xs" c="gray.7" style={{ lineHeight: 1.3 }}>
                      {meaning.explain.de}
                    </Text>
              ...
              {expandedItems.has(index) && (
                <Box mt="sm">
                  ...
                  <Stack gap="xs">
                    <div>
                      <Text size="xs" fw={500} c="gray.7" mb={2}>
